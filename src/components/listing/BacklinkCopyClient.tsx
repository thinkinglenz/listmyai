...
export default function BacklinkCopyClient({ slug }: { slug: string }) {
  ...
  return (
    <div className="flex min-w-0 items-center gap-2 overflow-hidden rounded-lg border px-3 py-2"
      style={{ borderColor: '#1e2a3a', background: '#0d1117' }}>
      <code className="min-w-0 flex-1 truncate text-xs text-slate-500">{html}</code>
