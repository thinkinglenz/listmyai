...
import { renderInstagramCard } from '@/lib/social/instagram-card'
...
export async function GET(req: NextRequest, { params }: { params: Promise<{ slug: string }> }) {
  ...
  const { data: tool } = await supabase
    .from('ai_tools')
    .select('name, slug, tagline, description, social_hook, website, logo_url, cover_url, video_url, categories(name)')
    .eq('slug', slug)
    .maybeSingle()
